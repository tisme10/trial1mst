...
window.addEventListener('load', () => {
    ...
    if (!room) {
        ...
        function init(createOffer, partnerName) {
            ...
            pc[partnerName].ontrack = (e) => {
                ...
                if (document.getElementById(`${partnerName}-video`)) {
                    ...
                    controlDiv.innerHTML = `<h6 style="color: white">${partnerName}</h6>
        ...
        document.getElementById('chat-input1').addEventListener('keypress', (e) => {
            if (e.which === 13 && (e.target.value.trim())) {
                e.preventDefault();
        ...
        //     h.toggleModal('share-invite-modal', true);
        // });
